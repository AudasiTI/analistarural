...
public interface FarmRepository extends CrudRepository<Farm, Long> {
	...
	Iterable<Farm> findFarmsBySystemAccount(@Param("system_account_id") Long system_account_id);
	...
	Optional<Farm> findByName(@Param("name") String name, @Param("system_account_id") Long system_account_id);
