...
$app.config(['$routeProvider','$httpProvider',function($routeProvider,$httpProvider){
	...
	when('/measurements',{templateUrl:'view/measurement/main.html',controller:'measurementController'}).
	when('/measurement/new',{templateUrl:'view/measurement/update.html',controller:'measurementController'}).
	when('/measurement/:id',{templateUrl:'view/measurement/update.html',controller:'measurementController'}).
			...
			return promise.then(function(response) {
			      ...
			      if ($error && $error.text)
			      	...
			      	if (response.status=404)
			      		...
			      		alert("ERROR! Veja o log no console");
			      }
